...
> |---|---|---|
> | **ראשי** | Obsidian vault מקומי — `C:\Users\NIMROD\Documents\Obsldian\nimis vault` | ❌ **לא** — דיסק מקומי. סשן ענן לא רואה אותו |
