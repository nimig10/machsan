...
> מסמך הקשר יחיד לסשנים חדשים. סנאפ-שוט עדכני נכון ל-**2026-05-31** (אחרי PR #39–#43: תיקוני מובייל + תצוגת זמן אחידה `HH:MM`, מייל תזכורת דדליין הפקה, hotfixes ל-missing-imports + הקשחת `no-undef` ל-`error`).
