...
| תאריך | PR | מה |
|---|---|---|
| 2026-07-29 | **#101** | לחצן היציאה בפאנל הבקשה בלוח הבקרה גלש מחוץ לכותרת — `minWidth:0` על flex item + "עריכת בקשה" לשורה משלו בכותרת הדביקה (לקח #30+#32) |
