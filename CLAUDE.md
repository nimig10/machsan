...
| תאריך | PR | מה |
|---|---|---|
| 2026-07-28 | **#99** | דחיית בקשה עם נימוק (מייל+וואטסאפ) + escaping ל-`custom_message`; "עריכת בקשה" בלוח הבקרה (`reservationEdit.js` משותף); סוג ההפקה נפתח לעריכה (לקח #46); פאנל מייל-נוסף לבקשה שנדחתה; פוסטר וידאו לפי יחס אמיתי (לקח #45); `useAutoGrowTextarea` |
